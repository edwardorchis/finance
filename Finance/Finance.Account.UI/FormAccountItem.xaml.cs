...
namespace Finance.Account.UI
{
    ...
    /// FormUser.xaml 的交互逻辑
    /// </summary>
    public partial class FormAccountItem : FinanceForm
    {
        public FormAccountItem()
        {            
            InitializeComponent();
            auxiliaryView.AuxGrp = Controls.Commons.AuxiliaryGroup.AccountItems;
        ...
        void AuxiliaryView_Selected(AuxiliaryObj item)
        {
            ...
            frm.AuxGrp = Controls.Commons.AuxiliaryGroup.AccountItems;
